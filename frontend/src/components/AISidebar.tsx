...
import { Bot, Send, Sparkles, Trash2, ChevronRight, ChevronLeft, Zap } from "lucide-react";
    ...
    <>
      ...
      {collapsed && (
        <button
          ...
          className="fixed right-0 top-1/2 -translate-y-1/2 z-40 flex flex-col items-center justify-center gap-1.5 bg-[var(--card)] border border-[var(--border)] border-r-0 rounded-l-2xl px-2 py-5 text-[var(--primary)] hover:bg-[var(--primary)] hover:text-black transition-all duration-200 shadow-[var(--shadow-card)]"
        >
          <Sparkles size={16} />
          <ChevronLeft size={12} />
        </button>
