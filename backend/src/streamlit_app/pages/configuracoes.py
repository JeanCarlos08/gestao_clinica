...
from infrastructure.connection import check_connection, get_diagnostics
from core.repositories.repositories import preferences_repo, auditoria_repo
from core.repositories.user_repositories import clinic_config_repo, user_repo
...
def _tab_perfil() -> None:
    ...
    with st.form("form_perfil"):
        ...
        if st.form_submit_button("💾 Salvar Perfil", type="primary"):
            from core.entities.user_models import UserUpdate
            update = UserUpdate(
    ...
    with st.form("form_novo_user"):
        ...
        if st.form_submit_button("➕ Criar Usuário", type="primary"):
            if not nu_username or not nu_nome or not nu_senha:
                ...
                from core.entities.user_models import UserCreate
