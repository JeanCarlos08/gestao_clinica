...
from .n8n_service import n8n_service, create_n8n_service
...
def get_n8n_service(use_singleton: bool = True):
    return n8n_service if use_singleton else create_n8n_service()
