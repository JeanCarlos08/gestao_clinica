...
import "./globals.css";
import { Home, ClipboardList, BarChart2, Upload, Settings, Bot, LogOut } from "lucide-react";
        ...
        <aside className="w-64 bg-[var(--sidebar-bg)] border-r border-[var(--border)] flex flex-col justify-between flex-shrink-0 z-10">
          <div className="overflow-y-auto scrollbar-hide pb-4">
            ...
            <nav className="px-3 space-y-1">
              ...
              <a href="#" className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-[var(--primary)] bg-[var(--card)] border-l-4 border-[var(--primary)] font-medium">
